...
# installed.
TCL_PREFIX='D:/Study/Data Science/DS-ML 2024/ML Project/nenv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/Study/Data Science/DS-ML 2024/ML Project/nenv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/Study/Data Science/DS-ML 2024/ML Project/nenv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/Study/Data Science/DS-ML 2024/ML Project/nenv\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/Study/Data Science/DS-ML 2024/ML Project/nenv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='D:/Study/Data Science/DS-ML 2024/ML Project/nenv\Library\lib\tclstub86.lib'
